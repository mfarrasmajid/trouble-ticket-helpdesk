...
@section('title', 'Manage Airflow Logs')
...
<div class="app-header-wrapper d-flex align-items-center justify-content-around justify-content-lg-between flex-wrap gap-6 gap-lg-0 mb-6 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
    ...
    <div class="d-flex flex-column justify-content-center">
        <!--begin::Title-->
        <h1 class="text-gray-900 fw-bold fs-2x mb-2">Manage Airflow Logs</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-base">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">Manage Airflow Logs</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<div class="row g-5">
    ...
    <div class="col-lg-12">        
        <div class="card card-flush shadow-sm p-5" id="manage_table">
            <div class="card-header">
                <h3 class="card-title fw-bolder">Data Lake</h3>
                ...
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th style="min-width: 200px; font-weight:600;">Table</th>
                            <th style="min-width: 50px; font-weight:600;">Date</th>
                            <th style="min-width: 50px; font-weight:600;">Kategori</th>
                            <th style="min-width: 50px; font-weight:600;">Success</th>
                            <th style="min-width: 50px; font-weight:600;">Pending</th>
                            <th style="min-width: 50px; font-weight:600;">Failed</th>
    ...
    <div class="col-lg-12">        
        <div class="card card-flush shadow-sm p-5" id="manage_table2">
            <div class="card-header">
                <h3 class="card-title fw-bolder">Data WareHouse</h3>
                <div class="card-toolbar">
                    <div class="d-flex align-items-center py-2">
                    </div>
                </div>
            ...
            <div class="card-body py-5">
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable2">
                    <thead>
                        <tr>
                            <th style="min-width: 30px; font-weight:600;">#</th>
                            <th style="min-width: 200px; font-weight:600;">Table</th>
    ...
    <div class="col-lg-12">        
        <div class="card card-flush shadow-sm p-5" id="manage_table3">
            <div class="card-header">
                <h3 class="card-title fw-bolder">Data Mart</h3>
                <div class="card-toolbar">
                    <div class="d-flex align-items-center py-2">
                    </div>
                </div>
            ...
            <div class="card-body py-5">
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable3">
                    <thead>
                        <tr>
                            <th style="min-width: 30px; font-weight:600;">#</th>
                            <th style="min-width: 200px; font-weight:600;">Table</th>
...
<script>
    ...
    var initTable = function initTable() {
      ...
      var datatable = table.DataTable({
        ...
        ajax: {
          url: "{{ url('/')}}/api/dwh/get_list_airflow_logs/Data Lake",
          data: {
      ...
      var PageInfo = $('#datatable').DataTable().page.info();
          ...
          datatable.column(-1, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = '<div style="white-space:nowrap">\
                              <a href="{{ url("dwh/detail_airflow_logs") }}/'+ cell.innerHTML + '" class="btn btn-sm btn-secondary me-2 px-5 py-2 my-1" title="Lihat Detail">\
                                Lihat Detail\
                              </a>\
                          </div>';
          });
      ...
      var datatable2 = table2.DataTable({
        ...
        // oSearch: {"sSearch": "{{Session::get('searchQry')}}" },
        ajax: {
          url: "{{ url('/')}}/api/dwh/get_list_airflow_logs/Data WareHouse",
          data: {
            _token : $("input[name='_token']").val()
          },
          type: 'POST',
      ...
      var PageInfo = $('#datatable').DataTable().page.info();
          datatable2.column(0, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = i + 1 + PageInfo.start;
          } );
          datatable2.column(-1, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = '<div style="white-space:nowrap">\
                              <a href="{{ url("dwh/detail_airflow_logs") }}/'+ cell.innerHTML + '" class="btn btn-sm btn-secondary me-2 px-5 py-2 my-1" title="Lihat Detail">\
                                Lihat Detail\
                              </a>\
      ...
      var datatable3 = table3.DataTable({
        ...
        // oSearch: {"sSearch": "{{Session::get('searchQry')}}" },
        ajax: {
          url: "{{ url('/')}}/api/dwh/get_list_airflow_logs/Data Mart",
          data: {
            _token : $("input[name='_token']").val()
          },
          type: 'POST',
      ...
      var PageInfo = $('#datatable').DataTable().page.info();
          datatable3.column(0, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = i + 1 + PageInfo.start;
          } );
          datatable3.column(-1, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = '<div style="white-space:nowrap">\
                              <a href="{{ url("dwh/detail_airflow_logs") }}/'+ cell.innerHTML + '" class="btn btn-sm btn-secondary me-2 px-5 py-2 my-1" title="Lihat Detail">\
                                Lihat Detail\
                              </a>\
