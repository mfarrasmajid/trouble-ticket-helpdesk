...
@section('title', 'Detail Airflow Logs')
...
<div class="app-header-wrapper d-flex align-items-center justify-content-around justify-content-lg-between flex-wrap gap-6 gap-lg-0 mb-6 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
    ...
    <div class="d-flex flex-column justify-content-center">
        <!--begin::Title-->
        <h1 class="text-gray-900 fw-bold fs-2x mb-2">Detail Airflow Logs</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
    ...
    <div class="col-lg-12">        
        <div class="card card-flush shadow-sm p-5" id="manage_table">
            <div class="card-header">
                <h3 class="card-title fw-bolder">Log by Table</h3>
            ...
            <div class="card-body py-5">
                <div class="fs-2x fw-bolder mb-1">Table Name: {{$data['table_name']}}</div>
                <div class="fs-3 mb-0">Data Type: {{$data['data_type']}}</div>
                <div class="fs-3 mb-5">Extract Method: {{$data['extract_method']}}</div>
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable">
                    <thead>
                        <tr>
                            <th style="min-width: 30px; font-weight:600;">#</th>
                            <th style="min-width: 100px; font-weight:600;">Log ID</th>
...
<script>
    ...
    var initTable = function initTable() {
      ...
      var datatable = table.DataTable({
        ...
        ajax: {
          url: "{{ url('/')}}/api/dwh/get_list_airflow_logs_detail/{{ $data['table_name'] }}",
          data: {
      ...
      var PageInfo = $('#datatable').DataTable().page.info();
          ...
          datatable.column(-1, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = '<div style="white-space:nowrap">\
                              <a href="{{ url("dwh/detail_airflow_logs_id") }}/'+ cell.innerHTML + '" class="btn btn-sm btn-secondary me-2 px-5 py-2 my-1" title="Lihat Detail">\
                                Lihat Detail\
                              </a>\
