...
<div class="app-header-wrapper d-flex align-items-center justify-content-around justify-content-lg-between flex-wrap gap-6 gap-lg-0 mb-6 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
    ...
    <div class="d-flex flex-column justify-content-center">
        <!--begin::Title-->
        <h1 class="text-gray-900 fw-bold fs-2x mb-2">Manage Users</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
    ...
    <div class="col-md-12">
        ...
        <div class="card card-flush shadow-sm p-5" id="manage_table">
            ...
            <div class="card-header">
                <h3 class="card-title fw-bolder">Manage Users</h3>
                <div class="card-toolbar">
                    <div class="d-flex align-items-center py-2">
                        <a href="{{ url('/admin/detail_users')}}" class="btn btn-sm btn-danger">Add User</a>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th style="min-width: 200px; font-weight:600;">Name</th>
...
<script>
    ...
    var initTable = function initTable() {
      ...
      var datatable = table.DataTable({
        ...
        ajax: {
          url: "{{ url('/')}}/api/admin/get_list_manage_users",
          data: {
              ...
              buttons: {
                  ya: {
                      ...
                      action: function(){
                          blockUI.block();
                          $.ajax({
                              url: "{{ url('/')}}/api/admin/delete_users/" + id,
                              type: 'POST',
                              data: formData,
                              processData: false,
                              contentType: false,
