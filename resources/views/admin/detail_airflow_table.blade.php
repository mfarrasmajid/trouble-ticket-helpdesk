...
@section('title', 'Detail Airflow Table')
...
<div class="app-header-wrapper d-flex align-items-center justify-content-around justify-content-lg-between flex-wrap gap-6 gap-lg-0 mb-6 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
    ...
    <div class="d-flex flex-column justify-content-center">
        <!--begin::Title-->
        <h1 class="text-gray-900 fw-bold fs-2x mb-2">Detail Airflow Table</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-base">
            ...
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">
                <a href="{{ url('/admin/manage_airflow_table') }}" class="text-muted text-hover-danger">Manage Airflow Table</a>
            </li>
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">/</li>
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">Detail Airflow Table</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<div class="row g-5">
    <div class="col-md-12">
        ...
        <div class="card card-flush shadow-sm p-5" id="detail_form">
            <form @if (isset($data['id'])) action="{{ url('/admin/detail_airflow_table') }}/{{$data['id']}}" @else action="{{ url('/admin/detail_airflow_table') }}" @endif enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-header">
                    <h3 class="card-title fw-bolder">@if(isset($data['id'])) Edit Airflow Table {{$data['u']->table_airflow}} @else Add Airflow Table @endif</h3>
                ...
                <div class="card-body py-5">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-5">
                                <label for="table" class="form-label">Airflow Table</label>
                                <input type="text" required class="form-control form-control-solid" name="table" @if (isset($data['id'])) value="{{ $data['u']->table_airflow }}" @endif>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-5">
                ...
                <div class="card-footer text-end">
                    <a href="{{ url('/admin/manage_airflow_table')}}" class="btn btn-secondary me-5">Back</a>
